...
function loadDataForIndex(cgf) {
	...
	var strTopChoiceElement = '<div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.0s">' +
		...
		'                                <a href="https://goo.gl/maps/XtBebJExTzCAwdjn6" data-google target="_blank" class="no-border"><i' +
...
function loadDataForSpecialties(cgf) {
	...
	'                                    <a href="https://www.facebook.com/newhollywoodnailsandspa" data-facebook target="_blank"><i class="fab fa-facebook-f"></i></a>'+
	'                                    <a href="https://www.instagram.com/newhollywoodnailsandspa.mi" data-instagram target="_blank"><i class="fab fa-instagram"></i></a>'+
	'                                    <a href="https://goo.gl/maps/XtBebJExTzCAwdjn6" data-google target="_blank" class="no-border"><i class="fab fa-google"></i></a>'+
	'                                </div>'+
	'                            </div>'+
	'                        </div>'+
	'                    </div>';
